(function() {
  ...
  MESSAGES.push({
    delay: 1200,
    text: "Желаю тебе счастья, здоровья,"
  });

  MESSAGES.push({
    delay: 2400,
    text: "Чтобы тебе никогда не приходилось проливать слёз горя."
  });

  MESSAGES.push({
    delay: 4400,
    text: "Всего самого наилучшего и счастливого времяпровождения"
  });

  MESSAGES.push({
    delay: 6800,
    text: "Ведь это твой день)"
  });
